...
# Crear el blueprint
ventas_tipo_bp = Blueprint('ventas_tipomovimiento_año', __name__)
...
def get_ventas_tipo_año(tabla_usuario):
...
def get_ventas_por_tipo(tabla_usuario):
    """
    Endpoint para obtener el resumen de ventas por tipo de movimiento y año.
    """
    resultado = get_ventas_tipo_año(tabla_usuario)
