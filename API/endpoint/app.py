...
from endpoint.todas_transacciones_sin_filtro_endpoint import todas_transacciones_sin_bp
...
from endpoint.ventas_año_endpoint import ventas_años_bp
from endpoint.cashback_emitido_año_endpoint import cashback_emitido_año_bp
from endpoint.compras_categoria_mes_año_endpoint import compras_categoria_mes_año_bp
from endpoint.total_movimientos_categorias_endpoint import total_movimientos_categorias_bp
...
app.register_blueprint(todas_transacciones_sin_bp)
...
app.register_blueprint(compras_categoria_mes_año_bp)
app.register_blueprint(total_movimientos_categorias_bp)
...
def home():
    ...
    return jsonify({
        ...
        "endpoints_disponibles": {
            ...
            "todas_transacciones_sin_filtro": "/todas_transacciones_sin_filtro/<tabla_usuario>",
            ...
            "ventas_año": "/ventas_año/<tabla_usuario>",
            "ventas_pie": "/ventas_tipo_movimiento_pie/<tabla_usuario>?mes=<mes>&anio=<anio>",
            "compras_categorias": "/compras_por_categoria/<tabla_usuario>",
            "total_movimientos_categorias": "/total_movimientos_categorias/<tabla_usuario>",
            "tablas_permitidas": list({"ilandatxe", "fotostorres", "alex", "categorias"})
        },
        "ejemplos_uso": {
            "cashback_emitido": "/cashback_emitido_mes_año/ilandatxe",
            "cashback_emitido_año": "/cashback_emitido_año/ilandatxe",
            ...
            "todas_transacciones_sin_filtro": "/todas_transacciones_sin_filtro/ilandatxe",
            ...
            "ventas_año": "/ventas_año/fotostorres",
            "ventas_pie": "/ventas_tipo_movimiento_pie/fotostorres?mes=1&anio=2024",
            "compras_categorias": "/compras_por_categoria/ilandatxe",
            "total_movimientos_categorias": "/total_movimientos_categorias/ilandatxe"
        }
    })
